...
$(function(){
   ...
   $("#eemailCheck").click(function() {
    ...
    $(".button_join").click(function() {
      ...
      if (eemail2 == "" ) {
          $("#eemail2").focus();
          $("#eemail2Msg").text("이메일을 입력해주세요.");
          $("#eemail2Msg").css("color", "red");
          return false;
       } 
      ...
      if (ename_reg.test(ename)) {
       ...
       if (errn == "" || errn.length != 6) {
         ...
         if (eaccount == "" || eaccount.length != 8) {
            $("#eaccount").focus();
            $("#eaccountMsg").text("계좌번호는 8자리 입니다.");
            $("#eaccountMsg").css("color", "red");
            return false;
         }

         if (num_reg.test(eaccount)) {
            $("#eaccount").focus();
            $("#eaccountMsg").text("계좌번호에 숫자만 사용할 수 있습니다.");
            $("#eaccountMsg").css("color","red");
            return false;
         }
         ...
         <form action="./join" method="post" enctype="multipart/form-data">
               ...
               <tbody>
                     <tr class="atList5">         
                        ...
                        <th>회사이메일</th>
                           <td class="td2">
                              <input type="text" name="eemail" id="eemail" placeholder="이메일" maxlength="32">
                              <input type="text"  value="@ehr.net" disabled="disabled">
                        ...
                        <th>개인이메일</th>
                           <td>
                              <input type="text" name="eemail2" id="eemail2" placeholder="이메일" maxlength="40">
                     ...
                     <tr>
                        <th>계좌번호</th>
                           <td>
                              <input type="text" name="eaccount" id="eaccount" placeholder="계좌번호" maxlength="8">
