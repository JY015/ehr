                     ...
                     <tbody>
                        <c:forEach items="${list }" var="row">
                           <tr>
                              ...
                              <td class="tdtitle" style="width:450px; min-width: 450px; max-width: 450px;" onclick="location.href='./annonyDetail?num=${row.rowNum}'">${row.abtitle}<c:if test="${row.commentcount gt 0 }">    <h5 style="display: inline;">[${row.commentcount}]</h5></c:if> </td>
