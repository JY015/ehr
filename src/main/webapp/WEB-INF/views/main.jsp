...
<body>
   ...
   <article id="article">
            <div class="flexbox">
               ...
               <div class="item">   
               <div class="nameset6">
                       <div class="nameset_title">금일출결현황</div>
                       <br>
               <a href="./attend"><img src="./img/attend.png" class="attend_img" ></a><br>
                <br>
				<c:if test="${atmgdate == 'exist' }">
                <c:out value="${fn:substring(list2[0].atmgstr,0,5)} 출근완료 "/><img alt="" src="./img/check.png" class="cimg"><br>
                <c:if test="${list2[0].atmgend != null}">
                
                <c:out value="${fn:substring(list2[0].atmgend,0,5)} 퇴근완료 " /><img alt="" src="./img/check.png" class="cimg"><br>
                <br>
                <c:choose>
               			<c:when test="${list2[0].atmgsts eq 0}">
                   	 	<div class="sts-img">정상 출근</div>
               		 	</c:when>

                		<c:when test="${list2[0].atmgsts eq 1}">
                   		 <div class="sts-img">지각</div>
                		</c:when>
                
               		 	<c:when test="${list2[0].atmgsts eq 2}">
                    		<div class="sts-img">조퇴</div>
                		</c:when>
                
               			 <c:when test="${list2[0].atmgsts eq 3}">
