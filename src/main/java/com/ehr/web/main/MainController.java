	...
	@GetMapping("/main")
	   public String main(Map<String, Object> map, HttpSession session, Model model) {
	      ...
	      if (session.getAttribute("eid") != null && session.getAttribute("eid") != "") {
	         ...
	         String atmgdate = String.valueOf(list2.get(0).get("atmgdate"));
...
//2023-09-12 추가
	...
	public String memberlist(Model model, HttpSession session) {
		 ...
		 Integer egrade = (Integer) session.getAttribute("egrade");
			...
			Map<String, Object> totalemployee = mainService.totalemployee();
			System.out.println(String.valueOf(totalemployee).substring(7,9));
			model.addAttribute("totalemployee",String.valueOf(totalemployee).substring(7,9));
